...
public interface PersonnelRep extends JpaRepository<Personnel, CleLigCession>{
	...
	@Query(value="select  p.cod_soc,\r\n"
			...
			+ "    p.dat_tit,\r\n"
			+ "    p.cod_serv,\r\n"
			+ "    (pk_get_lib.GET_SERVICE$LIB_SERV(p.cod_soc,p.cod_serv)) lib_serv,\r\n"
			+ "    cod_fonct,\r\n"
			+ "    (pk_get_lib.GET_FONCTIONS$LIB_FONCT(p.cod_fonct,'F')) lib_fonct,\r\n"
			+ "    p.cod_categ,\r\n"
			+ "    (pk_get_lib.GET_CATEG$LIB_CATEG(p.cod_categ)) lib_categ,\r\n"
			+ "    cod_cat,\r\n"
			+ "    (pk_get_lib.GET_CATEGORIE$LIB_CAT(p.cod_categ,p.cod_cat)) lib_cat,\r\n"
			+ "    p.cod_grad,\r\n"
			+ "    (pk_get_lib.GET_GRADE$LIB_GRAD(p.cod_categ,p.cod_cat,p.cod_grad)) lib_grad,\r\n"
			+ "    p.cod_motif,\r\n"
			+ "    (pk_get_lib.GET_MOTIF_SORT$LIB_MOTIF(p.cod_motif)) lib_motif,\r\n"
			+ "    p.cod_natp,\r\n"
			+ "    p.cod_stat,\r\n"
			+ "    p.dat_serv,\r\n"
			+ "    p.dat_fonct,\r\n"
			...
			+ "    p.dat_nais,\r\n"
			+ "    p.etat_act,\r\n"
			+ "    (pk_get_lib.GET_ETAT_PAIE$LIB_ETAT(p.etat_act)) lib_etat_act,\r\n"
			+ "    p.qualf,\r\n"
			+ "    p.cod_ech,\r\n"
			+ "    p.cod_affect,\r\n"
			+ "    (pk_get_lib.GET_AFFECTATIO$LIB_AFFECT(p.cod_affect)) lib_affect,\r\n"
			+ "    p.cod_niveau,\r\n"
			+ "    (pk_get_lib.GET_PARAM_NIVE$LIB_NIVEAU(p.cod_niveau))lib_niveau,\r\n"
			+ "    p.poste_trav,\r\n"
			+ "    (pk_get_lib.GET_POSTE_TRAV$LIB_POST(p.poste_trav)) lib_poste_trav,\r\n"
			+ "    p.cod_metier,\r\n"
			+ "    (pk_get_lib.GET_METIER$LIB_METIER(p.cod_metier)) lib_cod_metier,\r\n"
			+ "    p.adm_tech,\r\n"
			+ "    (pk_get_lib.GET_TYP_ADM_TE$LIB_ADM_TECH(p.adm_tech)) lib_adm_tech,\r\n"
			+ "    p.dat_stat,\r\n"
			+ "    p.dat_cin,\r\n"
			+ "    p.lie_emi_cin,\r\n"
			+ "    p.dat_affect,\r\n"
			+ "    p.lieu_nais,\r\n"
			+ "    p.cod_lieu_geog,\r\n"
			+ "    (pk_get_lib.GET_PRM_LIEU_G$LIB_LIEU(p.cod_lieu_geog)) lib_lieu_geog,\r\n"
			+ "    p.dat_lieu_geog,\r\n"
			+ "    p.grp_sang,\r\n"
			+ "    p.num_retr,\r\n"
			+ "    p.cod_fil,\r\n"
			+ "    (pk_get_lib.GET_FILLIERE$LIB_FIL(p.cod_fil)) lib_fil,\r\n"
			+ "    p.dat_fil,\r\n"
			+ "    p.serv_mil,\r\n"
			+ "    (pk_get_lib.GET_PRM_MILITA$LIB_MIL(p.serv_mil)) lib_mil,\r\n"
			+ "    p.code_domaine,\r\n"
			+ "    (pk_get_lib.GET_LISTE_DOMA$LIB_DOMAINE(p.code_domaine)) lib_domaine,\r\n"
			+ "    p.cod_class,\r\n"
			+ "    (pk_get_lib.GET_CLASSE_ADM$LIB_CLASS(p.cod_class)) lib_class,\r\n"
			+ "    p.dat_class,\r\n"
			+ "    p.cod_typ_depart,\r\n"
			+ "    p.dat_depart,\r\n"
			+ "    p.org_serv,\r\n"
			...
			+ "    p.presum_nais,\r\n"
			+ "    p.cod_gouv,\r\n"
			+ "    (pk_get_lib.GET_GOUVERNORA$LIB_GOUV(p.cod_gouv)) lib_gouv,\r\n"
			+ "    p.benef_allf,\r\n"
			+ "    p.num_acc,\r\n"
			+ "    p.id_personnel\r\n"
			+ "From personnel p  \r\n"
