...
public class AdrPers implements Serializable {
	...
	public AdrPers(CleAdrPers id, String cod_gouv, String cod_deleg, String cod_post, String rue, String rue_a,
			...
			String cod_user, String lib_gouv, String libnompre) {
		super();
		this.id = id;
		...
		this.libnompre = libnompre;
	}

	public String getLibnompre() {
		return libnompre;
	}

	public void setLibnompre(String libnompre) {
		this.libnompre = libnompre;
	}
